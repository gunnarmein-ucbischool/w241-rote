...
We conduct a randomization inference under the sharp null-hypothesis of absolutely no effect to get another angle on how statistically sound our results might be. Out split of 47/50 was sufficiently close to even that we will use p = 0.5 for our assignment probabilities.
